    ...
    return (
      <div className="landing-auth">
        <div className="hero-card">
          ...
          <button className="btn outline" onClick={handleStart}>Entrar como Anónimo</button>
          <button className="btn subtle" onClick={handleStart}>Explorar sem conta</button>
      ...
      <header className="landing-header">
        ...
        {user ? (
          <div className="auth-link">
            ...
            <button
              onClick={() => { localStorage.removeItem('auth_token'); localStorage.removeItem('auth_user'); navigate('/'); setUser(null); }}
